...
app.use("/api/admin", require("./routes/adminController"));
app.use("/api/bookmark", require("./routes/bookmarkController"));
app.use("/api/advance-search", require("./routes/advanceSearchController"));
